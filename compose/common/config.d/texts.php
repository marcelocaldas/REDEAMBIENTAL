...
return [
    "text:home-header.title" => i::__("Boas-vindas a JP Cultura"),
    "text:home-header.description" => i::__("A JP Cultura é uma ferramenta de gestão cultural que garante a estruturação de Sistemas de Informações e Indicadores."),
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com a JP Cultura."),
    "text:home-register.description" => i::__("Contribua com a plataforma livre e interativa de mapeamento do cenário cultural e instrumento de governança digital no aprimoramento da gestão pública, dos mecanismos de participação e da democratização do acesso às políticas culturais promovidas pela Fundação de Cultura de João Pessoa."),
    'text:home-developers.description' => 'Além disso, JP Cultura é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',

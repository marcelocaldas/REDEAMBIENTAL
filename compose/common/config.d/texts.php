...
return [
    "text:home-header.title" => i::__("Boas-vindas ao JP Cultura"),
    "text:home-header.description" => i::__("O JP Cultura é uma ferramenta de gestão cultural que garante a estruturação de Sistemas de Informações e Indicadores."),
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o JP Cultura."),
